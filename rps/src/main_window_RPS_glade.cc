...
{  
   ...
   toolbar_main->tools().push_back(Gtk::Toolbar_Helpers::ToggleElem(_("Play CD"), *manage(new Gtk::Image(Gtk::StockID("gtk-jump-to"), Gtk::ICON_SIZE_LARGE_TOOLBAR)), Gtk::Toolbar_Helpers::Callback0()));
   togglebutton_play_dir = static_cast<Gtk::ToggleButton *>(toolbar_main->tools().back().get_widget());
   
   toolbar_main->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Stop CD"), *manage(new Gtk::Image(Gtk::StockID("gtk-stop"), Gtk::ICON_SIZE_LARGE_TOOLBAR)), Gtk::Toolbar_Helpers::Callback0()));
