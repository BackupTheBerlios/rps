...
{  
   ...
   toolbar_main->tools().push_back(Gtk::Toolbar_Helpers::ToggleElem(_("Play Directory"), *manage(new Gtk::Image(Gtk::StockID("gtk-jump-to"), Gtk::ICON_SIZE_LARGE_TOOLBAR)), Gtk::Toolbar_Helpers::Callback0()));
