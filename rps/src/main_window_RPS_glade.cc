...
{  
   ...
   treeview_playlist = Gtk::manage(new class Gtk::TreeView());
   
   Gtk::ScrolledWindow *scrolledwindow2 = Gtk::manage(new class Gtk::ScrolledWindow());
   Gtk::ScrolledWindow *scrolledwindow_playlist = Gtk::manage(new class Gtk::ScrolledWindow());
   ...
   treeview_playlist->set_flags(Gtk::CAN_FOCUS);
   treeview_playlist->set_headers_visible(true);
   treeview_playlist->set_rules_hint(false);
   treeview_playlist->set_reorderable(false);
   treeview_playlist->set_enable_search(true);
   ...
   treeview_playlist->signal_row_activated().connect(SigC::slot(*this, &main_window_RPS_glade::on_treeview_playlist_row_activated));
   treeview_playlist->signal_button_release_event().connect(SigC::slot(*this, &main_window_RPS_glade::on_treeview_playlist_button_release_event));
}
